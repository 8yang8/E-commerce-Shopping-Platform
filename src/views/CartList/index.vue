...
<template>
  <div class="xtx-cart-page">
    <div class="container m-top-20">
      <div class="cart">
        <table>
          <thead>
            <tr>
              <th width="120">
                <el-checkbox :model-value="cartStore.cartList.every((i) => i.selected)" @change="(val) => toggleAll(val)"/>
              </th>
      ...
      <div class="action">
        <div class="batch">
          共 {{cartStore.cartCount}} 件商品，已选择 {{cartStore.selectedCount}} 件，商品合计：
