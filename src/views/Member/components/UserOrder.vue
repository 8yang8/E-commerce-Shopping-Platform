...
const getUserOrder = async () => {
  const res = await getUserOrderAPI(params.value)  // 请求缓慢，需要延长请求超时时间
...
// tab切换
// type:el的tab-change传递参数的默认TabPaneName值
      ...
      <div class="main-container">
        ...
        <div v-else>
          ...
          <div class="pagination-container">
            <el-pagination  background layout="prev, pager, next" :total="total" :page-size="2" @current-change="pageChange"/>
          </div>
        </div>
      </div>
